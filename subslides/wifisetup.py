...
wifinetworkstext = pi3d.FixedString('fonts/opensans.ttf', 'Please choose your WIFI-network' , font_size=42, shadow_radius=4,justify='L', background_color=(0,0,0,30), color= (255,255,255,255),camera=graphics.CAMERA, shader=graphics.SHADER, f_type='SMOOTH')
...
def inloop(x = 0, y = 0, touch_pressed = False, textchange = False,activity = False, offset = 0):
       ...
       if wifinetworks == None:
        ...
        for network in wifinetworks:
         ...
         wifinetworks[actnetwork]['string'] = pi3d.FixedString('fonts/opensans.ttf','SSID: '+(str)(network['essid']) + ', Enc:' + (str)(network['enc']) + '  Ch:' + (str)(network['ch']) , font_size=32,shadow_radius=4,justify='L', background_color=(0,0,0,30), color= (255,255,255,255),camera=graphics.CAMERA, shader=graphics.SHADER, f_type='SMOOTH')
