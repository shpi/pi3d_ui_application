...
matshader = pi3d.Shader("mat_flat")
...
# fake slider  ball
ball = pi3d.Disk(radius=100, sides=36, z=1, rx=90, camera=CAMERA) # default orientated in x,z plane so rotate
ball.set_shader(matshader) # need material shader really
ball.set_material((1, 1, 1)) # uses actual loaded background :-) how to smooth borders?
ball.set_alpha(0.2) # make the disk see-through
