...
def make_text_block(x, y, txt):
    return pi3d.TextBlock(x, y, 0.1, 0.0, 8,text_format=txt, size=0.69, spacing="C",
                            space=2.2, colour=(1.0, 1.0, 1.0, 1.0))
        ...
        if 150 < peripherals.lasty <  240:
            if 192 < peripherals.lastx < 289:
                ...
                with open('/etc/wpa_supplicant/wpa_supplicant.conf', 'w') as f:
                    ...
                    f.write('network={\n') 
                    f.write('ssid="' + wifisetup.wifinetworks[wifisetup.selectednetwork]['essid'] + '"\n') 
                    ...
                    if wifisetup.wifinetworks[wifisetup.selectednetwork]['enc'] == 'off':
                        ...
                        f.write('wep_key0="'+ peripherals.eg_object.usertext  +'"\n')
                        f.write('key_mgmt=NONE\n')
