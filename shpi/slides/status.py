...
add_to_text3(-380, 120, 22,
             text_format="WIFI SIG: {:s}dbm", attr="wifistrength")
...
add_to_text3(-380, 0, 22,
             text_format="Backlight:{:3d}", attr="backlight_level")
...
if hasattr(peripherals.eg_object, 'pressure'):
    add_to_text3(-380, -180, 22,
                 text_format="Pressure: {:2.1f}hPa", attr="pressure")
    add_to_text3(-380, -210, 20,
                 text_format="BMP280:   {:2.1f}", attr="bmp280_temp")
if hasattr(peripherals.eg_object, 'lightlevel'):

    add_to_text3(-50, 210, 20,
                 text_format="LightLvl: {:2.1f}lx", attr="lightlevel")
...
add_to_text3(0, 30, 20, text_format="{:3d}",
             attr="led_red", colour=(1.0, 0.0, 0.0, 1.0))
add_to_text3(50, 30, 20, text_format="{:3d}",
             attr="led_green", colour=(0.0, 1.0, 0.0, 1.0))
